# Install script for directory: /home/user/Desktop/AI/fann/src
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES
    "/home/user/Desktop/AI/fann/src/libfloatfann.so.2.2.0"
    "/home/user/Desktop/AI/fann/src/libfloatfann.so.2"
    )
  foreach(file
      "$ENV{DESTDIR}/usr/local/lib/libfloatfann.so.2.2.0"
      "$ENV{DESTDIR}/usr/local/lib/libfloatfann.so.2"
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/user/Desktop/AI/fann/src/libfloatfann.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libfloatfann.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libfloatfann.so")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE STATIC_LIBRARY FILES "/home/user/Desktop/AI/fann/src/libfloatfann.a")
endif()
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES
    "/home/user/Desktop/AI/fann/src/libdoublefann.so.2.2.0"
    "/home/user/Desktop/AI/fann/src/libdoublefann.so.2"
    )
  foreach(file
      "$ENV{DESTDIR}/usr/local/lib/libdoublefann.so.2.2.0"
      "$ENV{DESTDIR}/usr/local/lib/libdoublefann.so.2"
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/user/Desktop/AI/fann/src/libdoublefann.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libdoublefann.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libdoublefann.so")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE STATIC_LIBRARY FILES "/home/user/Desktop/AI/fann/src/libdoublefann.a")
endif()
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES
    "/home/user/Desktop/AI/fann/src/libfixedfann.so.2.2.0"
    "/home/user/Desktop/AI/fann/src/libfixedfann.so.2"
    )
  foreach(file
      "$ENV{DESTDIR}/usr/local/lib/libfixedfann.so.2.2.0"
      "$ENV{DESTDIR}/usr/local/lib/libfixedfann.so.2"
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/user/Desktop/AI/fann/src/libfixedfann.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libfixedfann.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libfixedfann.so")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE STATIC_LIBRARY FILES "/home/user/Desktop/AI/fann/src/libfixedfann.a")
endif()
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES
    "/home/user/Desktop/AI/fann/src/libfann.so.2.2.0"
    "/home/user/Desktop/AI/fann/src/libfann.so.2"
    )
  foreach(file
      "$ENV{DESTDIR}/usr/local/lib/libfann.so.2.2.0"
      "$ENV{DESTDIR}/usr/local/lib/libfann.so.2"
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/user/Desktop/AI/fann/src/libfann.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libfann.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libfann.so")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE STATIC_LIBRARY FILES "/home/user/Desktop/AI/fann/src/libfann.a")
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for each subdirectory.
  include("/home/user/Desktop/AI/fann/src/include/cmake_install.cmake")
